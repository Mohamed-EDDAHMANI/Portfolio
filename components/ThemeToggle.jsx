...
const ThemeToggle = () => {
  ...
  if (!mounted) {
    return (
      <button className="fixed bottom-6 right-6 z-50 w-14 h-14 sm:w-16 sm:h-16 bg-gray-200 dark:bg-primary-dark border-2 border-orange-500 dark:border-accent rounded-full flex items-center justify-center transition-all duration-300 shadow-lg">
